...
<style>
body{
    background-image: url('https://img.lovepik.com/photo/20211201/large/lovepik-golden-wheat-field-picture_501352166.jpg'); 
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand mb-2">
                        <img src="{{ asset('assets/img/logo.png') }}" alt="" width="300px" height="85px">
                    </div>
                    ...
                    <!--    {{__('Dont have an account?')}} <a href="">{{ __('Register') }}</a>-->
                    <!--</div>-->
                    <div class="simple-footer">
                        <!--{{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright AccountGo') }} {{ date('Y') }}-->
                        {{ date('Y') }} © All rights reserved by AASHIQ FARM. Design & Developed By GEXTON INC.
                    </div>
                </div>
            </div>
        </div>
