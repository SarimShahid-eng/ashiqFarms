...
@include('partials.inventory_admin.head')
...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        @include('partials.inventory_admin.header')

        @include('partials.inventory_admin.menu')
        <div class="main-content">
            @include('partials.inventory_admin.content')
        </div>
...
@include('partials.inventory_admin.footer')
<script>
