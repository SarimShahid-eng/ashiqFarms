@if(isset($edit) && $edit == TRUE)
    @forelse($expense_data AS $data)
        <tr class="d{{$data->id}}">
            <td> 
                <select  id="" class="form-control main_head" name="head[]" required>
 ...
 @else
    <tr>
        ...
        <td><input type="text" class="form-control" name="work[]" required>
            <table style="width: 100%">
                <tr>
                    <td>&nbsp;</td>
                </tr>
        ...
        <td><input type="number" step="0.01" class="form-control" name="unit_rate[]" required>
            <table style="width: 100%">
                <tr>
                    <td>&nbsp;</td>
                </tr>
