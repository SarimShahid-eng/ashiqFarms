                    ...
                    <div class="card-body">
                        <div class="profile-sidebar">
                            <div class="portlet light profile-sidebar-portlet ">
                                <div class="profile-userpic" style="height: auto">
                                    @if(!empty($userDetail->avatar))
                                        @if (file_exists(public_path('uploads/profile_images/'.$userDetail->avatar)))
                                            <img src="{{ asset('public/uploads/profile_images/'.$userDetail->avatar) }}" alt="" class="img-fluid">
                                        @else
                                        <img alt="image" src="{{(!empty($userDetail->avatar))}}" width="100px">
                                ...
                                <div class="profile-usertitle" style="width: 90%;margin: 0 auto;background: rgba(255,255,255,0.8);position: absolute;padding: 10px 0;bottom: 20px;">
                                    <div class="profile-usertitle-job font-style"> {{$userDetail->name}}</div>
                                ...
                                <div class="setting-tab">
                                    ...
                                    <div class="tab-content" id="myTabContent2">
                                        <div class="tab-pane fade show active" id="personal_info" role="tabpanel" aria-labelledby="home-tab3">
                                            {{Form::model($userDetail,array('route' => array('update.account'),'class'=>'ajaxForm','method' => 'put', 'enctype' => "multipart/form-data"))}}
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail thumbnail-h2">
                                                            @if(!empty($userDetail->avatar))
                                                                @if(file_exists(public_path('uploads/profile_images/'.$userDetail->avatar)))
                                                                    <img src="{{ asset('public/uploads/profile_images/'.$userDetail->avatar) }}" alt="" width="100%"></div>
                                                                @else
                                        ...
                                        <div class="tab-pane fade" id="change_password" role="tabpanel" aria-labelledby="profile-tab3">
                                            <div class="company-setting-wrap">
                                                {{Form::model($userDetail,array('route' => array('update.password',$userDetail->id),'class'=>'ajaxForm', 'method' => 'put'))}}
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
